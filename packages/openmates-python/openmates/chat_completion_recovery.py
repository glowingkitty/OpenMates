"""
Sealed chat-completion recovery primitives for the OpenMates pip SDK.

The byte contract mirrors backend, web, CLI, and Apple implementations. Raw
chat keys and derived recovery private keys stay local; only public keys and
sealed envelopes cross the API boundary.
"""
