...
if __name__ == "__main__":
    ...
    add_to_log(f"gpt-3.5-turbo-1106: {round(gpt_3_5_turbo['total_costs_min'],4)} {gpt_3_5_turbo['currency']}")
    add_to_log(f"gpt-4-1106-preview: {round(gpt_4_turbo['total_costs_min'],4)} {gpt_4_turbo['currency']}")
