    ...
    return {
        ...
        "function": {
            ...
            "description": (
                ...
                "5. NO COMPANY/BRAND SUBJECTS: Content whose primary subject is a company, brand, "
                "product, app, or commercial service = REJECT, even if the source is Wikipedia, an "
                "independent educator, or a neutral-looking documentary. Reframe to the underlying "
                "non-commercial concept instead. Examples: SpaceX, Tesla, Apple, Google, Meta, "
                "Amazon, Microsoft, OpenAI, Notion, iPhone = REJECT when they are the hero subject.\n"
                "6. NO PROHIBITED CONTENT: Drugs, explicit sexual content, graphic violence, "
                "self-harm, weapons manufacturing = REJECT.\n\n"
                "ACCEPTABLE: Education, science, history, how-things-work, documentaries, "
                "university lectures, independent creator explainers, and non-commercial concepts. "
                "Religion as academic study (history, architecture, philosophy) is OK if treated as study, not devotion.\n\n"
