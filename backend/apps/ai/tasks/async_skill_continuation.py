...
ASYNC_EMBED_REFERENCE_INSTRUCTION = (
    ...
    "For web sources, use natural short attribution such as according to CNBC and and WIRED; keep full headlines in previews. For other results use a short description; never show the embed_ref or its random suffix."
)
celery_app = None
