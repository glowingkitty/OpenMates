...
async def run_flush_server_stats(task: BaseServiceTask):
    ...
    try:
        ...
        daily_payload = {
            ...
            "free_testing_credits_granted": daily_incremental.get("free_testing_credits_granted", 0),
            "free_testing_grants_created": daily_incremental.get("free_testing_grants_created", 0),
...
async def update_monthly_stats(task: BaseServiceTask, year_month: str):
    ...
    try:
        ...
        monthly_payload = {
            ...
            "free_testing_credits_granted": sum(_int(d.get("free_testing_credits_granted")) for d in dailies),
            "free_testing_grants_created": sum(_int(d.get("free_testing_grants_created")) for d in dailies),
