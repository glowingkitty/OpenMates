...
def send_test_run_summary(
    ...
    Args:
        ...
        summary_copy: Optional English label overrides for non-test summaries
            that reuse the same admin email template.
...
async def _async_send_test_run_summary(
    ...
    try:
        ...
        copy_defaults = {
            ...
            "header_failure": "{failed} of {total} Tests Failed",
            "intro_note": "",
            "status_success": "PASSED",
            "status_failure": "{failed} FAILED",
            "item_label_plural": "tests",
            "passed_label": "passed",
            "failed_label": "failed",
            "skipped_label": "skipped",
            "not_started_label": "not started",
            "suites_label": "Test Suites",
            "suite_name_header": "Suite",
            "passed_header": "Passed",
            "failed_header": "Failed",
            "status_passed": "PASSED",
            "status_failed": "FAILED",
            "status_skipped": "SKIPPED",
            "failed_tests_label": "Failed Tests",
            "all_tests_label": "All Tests",
            "footer_note": "This report was generated by the automated daily test monitoring system.",
        }
