...
class AiModelDefaultsRequest(BaseModel):
    ...
    Allows the user to set a preferred default model for simple, complex, and
    most-demanding AI requests, which overrides auto-selection for all their
    future messages.
    ...
    default_ai_model_most_demanding: Optional[str] = Field(
        default=None,
        description="Default model for most-demanding requests. Null = auto-select. Format: 'provider/model_id'."
    )
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "default_ai_model_complex": "anthropic/claude-fable-5",
