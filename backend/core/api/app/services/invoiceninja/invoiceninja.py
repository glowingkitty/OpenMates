...
class InvoiceNinjaService:
    ...
    async def _async_init(self):
        ...
        self.API_TOKEN = await self.secrets_manager.get_secret(secret_path="kv/data/providers/invoice_ninja", secret_key="sandbox_api_key") # Using SANDBOX key as requested
