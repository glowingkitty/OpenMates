...
async def preview_incomplete_signup_deletion_reminder(
    ...
    return await _process_email_template(
        ...
        latest_announcement_video_link="https://openmates.org/#chat-id=announcements-introducing-openmates-v09&autoplay-video",
        announcement_thumbnail_url="https://openmates.org/newsletter-assets/intro-thumbnail-EN.jpg",
