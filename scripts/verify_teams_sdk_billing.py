...
const chat = await client.chats.send('SDK private Team note', {{ teamId, senderName: 'SDK verifier' }});
...
chat = client.chats.send('SDK private Team note', team_id=team_id, sender_name='SDK verifier')
