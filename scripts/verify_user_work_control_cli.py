...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="openmates-work-control-cli-") as home_value, tempfile.TemporaryDirectory(prefix="openmates-work-control-recovery-") as recovery_root:
        ...
        try:
            ...
            plan_id = identifier(cli(home, args.api_url, ["plans", "create", "--title", f"work-control-{suffix}", "--project", project_id]), "plan_id")
            ...
            plan_id = identifier(cli(home, args.api_url, ["plans", "list", "--project", project_id]), "plan_id")
            task_id = identifier(cli(home, args.api_url, ["tasks", "list", "--project", project_id]), "task_id")
