...
CLAIM_SOURCES = {
    ...
    'arch-infrastructure-cronjobs-behavior': ['.github/dependabot.yml', 'pnpm-workspace.yaml', 'scripts/_dependabot_helper.py', 'scripts/run_tests.py', 'scripts/auto_fix_failed_tests.py'],
    ...
    'arch-infrastructure-linear-auto-processing-behavior': ['scripts/linear-cron-setup.sh', 'scripts/session-cleanup.py', 'scripts/_linear_client.py', 'scripts/_zellij_utils.py'],
