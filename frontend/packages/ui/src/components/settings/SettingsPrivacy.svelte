...
<script lang="ts">
    ...
    function navigateToAutoDeletion(category: string) {
        dispatch('openSettings', {
            ...
            direction: 'forward',
            icon: 'delete',
            title: $text(`settings.privacy.privacy.auto_deletion.${category}`)
        });
    }
</script>
...
<div class="privacy-description">
    <p class="description-text">
        {$text('settings.privacy.privacy.description')}
    </p>
    <a
        ...
        class="privacy-link"
    >
        {$text('settings.privacy.privacy.open_privacy_policy')}
    </a>
</div>
...
<SettingsItem
    type="heading"
    icon="anonym"
    title={$text('settings.privacy.privacy.anonymization')}
/>
...
<SettingsItem
    type="subsubmenu"
    icon="anonym"
    subtitleTop={$text('settings.privacy.privacy.hide_personal_data.chats')}
...
<SettingsItem
    type="subsubmenu"
    icon="maps"
    subtitleTop={$text('settings.privacy.privacy.maps_location')}
    title={$text('settings.privacy.privacy.nearby_by_default')}
    hasToggle={true}
...
<SettingsItem
    type="heading"
    icon="desktop"
    title={$text('settings.privacy.privacy.device_permissions')}
/>

<SettingsItem
    type="subsubmenu"
    icon="recordaudio"
    title={$text('settings.privacy.privacy.microphone')}
    hasToggle={true}
...
<SettingsItem
    type="subsubmenu"
    icon="camera"
    title={$text('settings.privacy.privacy.camera')}
    hasToggle={true}
...
<SettingsItem
    type="subsubmenu"
    icon="maps"
    title={$text('settings.privacy.privacy.location')}
    hasToggle={true}
...
<SettingsItem
    type="heading"
    icon="delete"
    title={$text('settings.privacy.privacy.auto_deletion')}
/>
...
<SettingsItem
    type="subsubmenu"
    icon="chat"
    subtitleTop={$text('settings.privacy.privacy.auto_deletion.chats')}
    title={$text('settings.privacy.privacy.auto_deletion.chats.value')}
...
<SettingsItem
    type="subsubmenu"
    icon="files"
    subtitleTop={$text('settings.privacy.privacy.auto_deletion.files')}
    title={$text('settings.privacy.privacy.auto_deletion.files.value')}
    hasModifyButton={true}
...
<SettingsItem
    type="subsubmenu"
    icon="usage"
    subtitleTop={$text('settings.privacy.privacy.auto_deletion.usage_data')}
    title={$text('settings.privacy.privacy.auto_deletion.usage_data.value')}
    hasModifyButton={true}
...
<SettingsItem
    type="subsubmenu"
    icon="log"
    subtitleTop={$text('settings.privacy.privacy.auto_deletion.compliance_logs')}
    title={$text('settings.privacy.privacy.auto_deletion.compliance_logs.value')}
/>
...
<SettingsItem
    type="subsubmenu"
    icon="billing"
    subtitleTop={$text('settings.privacy.privacy.auto_deletion.invoices')}
    title={$text('settings.privacy.privacy.auto_deletion.invoices.value')}
/>

<!-- Compliance note -->
<div class="compliance-note">
    <p>{$text('settings.privacy.privacy.auto_deletion.compliance_note')}</p>
</div>
