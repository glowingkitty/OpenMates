<!--
Support One-Time Payment Confirmation - Success screen after one-time support payment
-->
...
<div class="success-section">
    ...
    <h2 class="ds-success-title">{$text('settings.support.payment_successful')}</h2>
</div>
