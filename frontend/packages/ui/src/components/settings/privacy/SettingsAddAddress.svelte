...
<div class="form-field">
    <input
        type="text"
        class="form-input"
        placeholder={$text('settings.privacy.privacy.form.title.placeholder_address')}
        bind:value={title}
    />
</div>
...
<SettingsItem
    type="heading"
    icon="text"
    title={$text('settings.privacy.privacy.form.first_line')}
/>
...
<div class="form-field">
    <input
        type="text"
        class="form-input"
        placeholder={$text('settings.privacy.privacy.form.first_line.placeholder')}
...
<SettingsItem
    type="heading"
    icon="text"
    title={$text('settings.privacy.privacy.form.second_line')}
/>
...
<div class="form-field">
    <input
        type="text"
        class="form-input"
        placeholder={$text('settings.privacy.privacy.form.second_line.placeholder')}
