<!--
Edit Name - Form for editing an existing name entry.
...
Related to: SettingsAddName.svelte, SettingsHidePersonalData.svelte
-->
...
<script lang="ts">
    ...
    // ─── Props — entry id is passed via settingsState from the router ─────────
    // The router passes component props via the settings navigation event.
    // We receive the entry id in $props().
    ...
    async function handleSave() {
        ...
        try {
            ...
            console.error('[SettingsEditName] Failed to update name entry:', error);
    ...
    async function handleDelete() {
        ...
        try {
            ...
            console.error('[SettingsEditName] Failed to delete name entry:', error);
