  ...
  {#if draft}
    ...
    <div class="editor" class:skill-editor={draft.type === 'app_skill_action'} style={style(draft)} data-testid="workflow-node-expanded">
      <WorkflowEditorHeader
        ...
        iconStyle={draft.type === 'app_skill_action' ? assetIconStyle(appIcon(draft), 16, 'var(--color-font-button)') : isCheck(draft) ? assetIconStyle('workflow-check', 16, 'var(--color-font-secondary)') : ''}
