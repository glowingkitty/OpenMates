<!--
  frontend/packages/ui/src/components/embeds/social_media/SocialMediaSearchEmbedFullscreen.svelte

  Fullscreen grid for Social Media / Search parent embeds.
  Uses SearchResultsTemplate to render one child card per social post and open
  each child in a focused overlay.
