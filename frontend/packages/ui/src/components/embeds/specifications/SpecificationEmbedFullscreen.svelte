...
<style>
  ...
  .summary { max-width: 540px; margin: 0 auto 12px; font-size: 17px; font-weight: 600; line-height: 1.6; }
  .preview-notice { color: var(--color-font-secondary); font-size: 12px; margin: 0; }
  .major-section { margin-top: 44px; }
  h2 { display: flex; align-items: center; gap: 18px; border-bottom: 3px solid var(--spec-accent); padding: 0 8px 13px; font-size: 20px; font-weight: 700; margin: 0 0 18px; line-height: 1.4; }
  ...
  .outcome { font-size: 17px; font-weight: 600; line-height: 1.6; margin: 0 8px 24px; }
  ...
  .boundaries h3 { font-size: 14px; margin: 4px 0 8px; }
  .boundaries ul { padding-left: 18px; margin: 0; color: var(--color-font-secondary); line-height: 1.6; font-size: 14px; }
  .boundaries li + li { margin-top: 7px; }
  .subheading { display: flex; align-items: center; gap: 18px; font-size: 17px; margin: 34px 8px 18px; }
  .requirement { margin: 24px 8px; }
  .applicability { display: flex; flex-wrap: wrap; gap: 8px 18px; font-size: 12px; margin: 0 0 11px 36px; }
  ...
  .proof-mark.passed { background: var(--color-success); border-color: var(--color-success); }
  .proof-mark .spec-icon { width: 16px; height: 16px; color: var(--color-font-button); }
  .requirement-body { min-width: 0; flex: 1; }
  .statement { font-size: 16px; font-weight: 650; line-height: 1.5; margin: 0 0 7px; }
  summary { cursor: pointer; list-style: none; }
  summary::-webkit-details-marker { display: none; }
  summary:focus-visible { outline: 3px solid var(--spec-accent); outline-offset: 5px; border-radius: 4px; }
  .proof-detail summary { display: flex; flex-wrap: wrap; align-items: center; gap: 6px 8px; font-size: 12px; }
  ...
  .proof-detail p, .requirement-details p { font-size: 13px; line-height: 1.6; padding: 12px; background: var(--color-grey-0); border-radius: 10px; margin: 10px 0; }
  .requirement-details { margin-top: 9px; color: var(--color-font-secondary); font-size: 12px; }
  ...
  .flow-state { display: inline-flex; align-items: center; align-self: flex-start; gap: 7px; margin: 12px 16px 8px; font-size: 12px; color: var(--color-font-secondary); }
  .flow-state > span { width: 10px; height: 10px; border-radius: 50%; background: var(--color-warning); }
  .flow-excerpt { padding: 0 22px 18px; line-height: 1.5; font-size: 13px; color: var(--color-font-secondary); flex: 1; }
  .flow-footer { display: flex; align-items: center; gap: 12px; background: var(--color-grey-10); border-top: 1px solid var(--color-grey-20); min-height: 58px; padding: 0 14px 0 0; border-radius: 28px; font-size: 15px; }
  ...
  .expand { margin-left: auto; color: var(--color-font-secondary); font-size: 20px; }
  details[open] > summary .expand { transform: rotate(45deg); }
  .flow-card ol { padding: 0 24px 10px 38px; line-height: 1.65; font-size: 14px; }
  .flow-card li + li { margin-top: 7px; }
  .architecture-card { width: min(340px, 100%); }
  .architecture-card p { padding: 0 20px 8px; font-size: 14px; line-height: 1.6; }
  .architecture-diagram { display: flex; align-items: center; justify-content: center; min-height: 126px; padding: 14px 20px; font-size: 12px; font-weight: 650; }
  ...
  .model-detail > summary { border-radius: 18px; background: var(--color-primary-start); color: var(--color-font-button); padding: 5px 12px; font-size: 12px; font-weight: 650; overflow-wrap: anywhere; }
  .model-detail[open] { flex-basis: 100%; }
  .model-detail[open] > summary { width: fit-content; }
  .model-content { padding: 14px 18px; margin-top: 12px; border: 1px solid var(--color-grey-25); border-radius: 14px; background: var(--color-grey-0); font-size: 13px; }
  .model-content p { line-height: 1.6; margin: 0; }
  dt { display: flex; flex-wrap: wrap; gap: 6px 12px; margin-top: 16px; font-weight: 600; }
  dt > span { color: var(--color-font-secondary); font-size: 12px; font-weight: 400; }
  ...
  @container (max-width: 480px) {
    ...
    h2 { font-size: 18px; gap: 12px; padding-left: 0; }
    .subheading { margin-left: 0; gap: 12px; }
    .requirement { margin-left: 0; margin-right: 0; }
    .applicability { gap: 7px 12px; font-size: 11px; }
    .statement, .outcome { font-size: 15px; }
  }
</style>
