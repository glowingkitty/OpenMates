...
const document: SpecificationDocument = {
  ...
  flows: [
    { id: 'create-team', title: 'Create a Team', kind: 'user_flow', steps: ['Open Settings → Teams.', 'Enter a name and optional description.', 'Accept or change the generated profile image.', 'Confirm creation; the creator becomes the owner.', 'Select the Team in the context switcher.'] },
