    ...
    <div class="image-fullscreen">
      ...
      {:else}
        <!-- Prompt area: "Generated by" line + quote card with prompt text.
             On desktop this sits on the left; on mobile it goes below the image. -->
        ...
        <!-- Image display with progressive loading:
             ...
             On desktop this sits on the right; on mobile it appears first (via CSS order). -->
...
<style>
  /* ===========================================
     ...
     Desktop: side-by-side (prompt left, image right)
     Mobile: stacked (image top, prompt below)
     =========================================== */
  ...
  /* ===========================================
     Prompt Area (left on desktop, below on mobile)
  ...
  /* ===========================================
     ...
     White rounded card matching Figma (30px radius)
     =========================================== */
  ...
  :global(.dark) .generated-by-line:hover {
  ...
  /* ===========================================
     Responsive: Mobile layout (stacked, image on top)
     =========================================== */
  ...
  @media (max-width: 768px) {
    ...
    /* On mobile: image appears first (top), prompt area below */
    .image-section {
      order: 1;
      flex: none;
