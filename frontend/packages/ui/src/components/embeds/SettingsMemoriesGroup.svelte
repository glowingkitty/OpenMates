<!--
  ...
  Clicking a card opens the Apps to that settings & memories category's detail page.
-->
...
<script lang="ts">
  ...
  /**
   * Handle settings & memories category card click - open the Apps to the category's detail page.
