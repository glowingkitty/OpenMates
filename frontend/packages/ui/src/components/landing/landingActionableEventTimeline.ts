...
export const ACTIONABLE_MOBILE_START_DELAY_MS = 1500;
export const ACTIONABLE_MOBILE_HEADING_FADE_OUT_MS = 420;
export const ACTIONABLE_MOBILE_HEADING_FADE_IN_MS = 420;
export const ACTIONABLE_MOBILE_HEADING_SWAP_MS = ACTIONABLE_MOBILE_HEADING_FADE_OUT_MS
