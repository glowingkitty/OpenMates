    ...
    >
        ...
        {:else}
            ...
            <div class="banner-content">
                ...
                <div class="banner-text">
                    <span class="banner-title">
                        {$text('notifications.push.banner_title.text', { default: 'Want to receive notifications when your assistant responds?' })}
                    </span>
                    <span class="banner-subtitle">
                        {$text('notifications.push.banner_subtitle.text', { default: "Even when you're not in the app." })}
                    </span>
                </div>
            </div>
            ...
            <div class="banner-actions">
                ...
                >
                    {#if isRequesting}
                        {$text('notifications.push.requesting.text', { default: 'Requesting...' })}
                    {:else}
                        {$text('notifications.push.enable_btn.text', { default: 'Enable Notifications' })}
                    {/if}
                </button>
                <button
                    ...
                    disabled={isRequesting}
                >
                    {$text('notifications.push.not_yet_btn.text', { default: 'Not Yet' })}
                </button>
            </div>
        {/if}
    </div>
