...
<div class="record-overlay" transition:slide={{ duration: 200, axis: 'y' }}>
    <div class="record-content">
        ...
        <h2 class="header-text">{@html $text('enter_message.record_audio.release_to_finish') || 'Release to finish'}</h2>
        ...
        <div class="controls-row">
            ...
            <div class="cancel-indicator">
                ...
                <span>{@html $text('enter_message.record_audio.slide_left_to_cancel') || 'Slide left to cancel'}</span>
            </div>
