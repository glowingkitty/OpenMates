...
export const variants = {
  ...
  /**
   * New assistant message — exercises the mate profile image path.
   * In production this fires when an AI reply arrives in a background chat.
   * The category field maps to a CSS class in mates.css that renders the profile image.
   */
  newAssistantMessage: {
    notification: {
      id: "preview-chat-notif-assistant",
      type: "chat_message" as const,
      message:
        "I found some great options for your trip to Barcelona! Let me share the details.",
      chatId: "preview-chat-assistant",
      chatTitle: "Travel Planning",
