<script lang="ts">
    ...
    import { externalLinks, privacyPolicyLinks } from '../config/links';
...
<div class="legal-container">
    <h1>{@html $text('legal.privacy.title.text')}</h1>

    <p class="last-updated">{@html $text('legal.privacy.last_updated.text')}: {buildDate}</p>
