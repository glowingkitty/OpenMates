...
//
// **Generated**: 2026-03-01T16:12:10.707Z
// **Models included**: 24
...
export const modelsMetadata: AIModelMetadata[] = [
  ...
  },
  {
    ...
    description:
      "FLUX.2 [klein] 4B Base image-to-image editing model. Accepts 1-4 reference images alongside a text prompt for style transfer, composition editing, or reference-guided generation.",
    provider_id: "bfl",
  ...
  },
  {
    ...
    description:
      "FLUX.2 [klein] 9B Base from Black Forest Labs. Enhanced realism, crisper text generation, and native editing capabilities.",
    provider_id: "bfl",
    provider_name: "Black Forest Labs",
    logo_svg: "icons/bfl.svg",
    country_origin: "US",
  ...
  },
  {
    ...
    name: "Gemini 3 Pro",
    description:
      "High-end native image generation and editing from Google. Supports text-to-image and image-to-image editing with up to 14 reference images.",
    provider_id: "google",
    provider_name: "Google",
    logo_svg: "icons/google.svg",
    country_origin: "US",
  ...
  },
  {
    ...
    name: "Voxtral Mini",
    description:
      "Mistral AI's compact audio transcription model. Converts speech to text with high accuracy across multiple languages. Optimised for short voice notes and recordings at the lowest cost.",
    provider_id: "mistral",
    provider_name: "Mistral AI",
    logo_svg: "icons/mistral.svg",
    country_origin: "FR",
  ...
  },
  {
    ...
    servers: [{ id: "openrouter", name: "OpenRouter", region: "US" }],
  ...
  },
  {
    ...
    name: "Recraft V4",
    description:
      "1024×1024 raster image generation from text prompts. Fast and cost-effective. Best for photos, realistic scenes, and general illustration.",
    provider_id: "recraft",
  ...
  },
  {
    ...
    description:
      "Convert raster images (PNG/JPG/WEBP) to scalable SVG vectors. Ideal for converting logos, icons, and illustrations to infinitely scalable vector format.",
    provider_id: "recraft",
    provider_name: "Recraft",
    logo_svg: "icons/recraft.svg",
    country_origin: "US",
