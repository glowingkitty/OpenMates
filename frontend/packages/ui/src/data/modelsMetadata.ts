...
export const modelsMetadata: AIModelMetadata[] = [
    ...
    },
    {
        ...
        servers: [{"id":"anthropic","name":"Anthropic API","region":"US"},{"id":"aws_bedrock","name":"AWS Bedrock","region":"EU"}],
        default_server: "anthropic",
    ...
    },
    {
        ...
        search_aliases: ["sonnet 4.5","claude 4.5 sonnet","claude-sonnet-4-5","claude-sonnet-4-5-20250929"],
    },
    {
        ...
        default_server: "fal",
        pricing: {"per_unit":{"credits":15,"unit_name":"image"}},
    },
    {
        id: "flux-2-klein",
    ...
    },
    {
        ...
        name: "Gemini 3 Flash",
        description: "Fast Gemini 3 preview model (primary: Google AI Studio US; fallbacks: Google Vertex AI global, OpenRouter).",
        provider_id: "google",
        ...
        servers: [{"id":"google_ai_studio","name":"Google AI Studio","region":"US"},{"id":"google","name":"Google Vertex AI","region":"global"}],
    ...
    },
    {
        ...
        name: "Gemini 3 Pro",
        description: "High-end native image generation and editing from Google. Supports text-to-image and image-to-image editing with up to 14 reference images.",
        provider_id: "google",
        provider_name: "Google",
        logo_svg: "icons/google.svg",
        country_origin: "US",
        ...
        servers: [{"id":"google_ai_studio","name":"Google AI Studio","region":"US"},{"id":"google","name":"Google Vertex AI","region":"global"}],
        default_server: "google_ai_studio",
        pricing: {"per_unit":{"credits":200,"unit_name":"image"}},
    },
    {
    ...
    },
    {
        ...
        name: "Voxtral Mini",
        description: "Mistral AI's compact audio transcription model. Converts speech to text with high accuracy across multiple languages. Optimised for short voice notes and recordings at the lowest cost.",
        provider_id: "mistral",
        provider_name: "Mistral AI",
        logo_svg: "icons/mistral.svg",
        country_origin: "FR",
        input_types: ["audio"],
        output_types: ["text"],
        for_app_skill: "audio.transcribe",
        tier: "standard",
        release_date: "2026-02-26",
        servers: [{"id":"mistral","name":"Mistral","region":"EU"}],
        default_server: "mistral",
        pricing: {"per_minute":3},
    },
    {
        id: "kimi-k2.5",
        name: "Kimi K2.5",
    ...
    },
    {
        id: "gpt-5.4",
        name: "GPT-5.4",
        description: "OpenAI's latest flagship model optimized for professional work, coding, and agentic tool use.",
        provider_id: "openai",
        ...
        servers: [{"id":"openai","name":"OpenAI API","region":"US"}],
        default_server: "openai",
        pricing: {"input_tokens_per_credit":130,"output_tokens_per_credit":20},
    },
    {
        id: "gpt-oss-120b",
        name: "GPT-OSS-120b",
    ...
    },
    {
        ...
        servers: [{"id":"recraft","name":"Recraft API","region":"US"}],
        default_server: "recraft",
        pricing: {"per_unit":{"credits":250,"unit_name":"image"}},
    },
    {
        ...
        servers: [{"id":"recraft","name":"Recraft API","region":"US"}],
        default_server: "recraft",
        pricing: {"per_unit":{"credits":300,"unit_name":"image"}},
    },
    {
        id: "recraftv4_vector",
        ...
        servers: [{"id":"recraft","name":"Recraft API","region":"US"}],
        default_server: "recraft",
        pricing: {"per_unit":{"credits":100,"unit_name":"image"}},
    },
    {
        id: "vectorize",
        name: "Recraft Vectorize",
        description: "Convert raster images (PNG/JPG/WEBP) to scalable SVG vectors. Ideal for converting logos, icons, and illustrations to infinitely scalable vector format.",
        provider_id: "recraft",
        provider_name: "Recraft",
        logo_svg: "icons/recraft.svg",
        country_origin: "US",
        input_types: ["image"],
        output_types: ["image"],
        for_app_skill: "images.vectorize",
        tier: "economy",
        release_date: "2026-02-01",
        servers: [{"id":"recraft","name":"Recraft API","region":"US"}],
        default_server: "recraft",
