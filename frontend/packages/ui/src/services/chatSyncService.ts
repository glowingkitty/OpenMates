...
export class ChatSynchronizationService extends EventTarget {
    ...
    private registerWebSocketHandlers() {
        ...
        webSocketService.on('phase_2_last_20_chats_ready', (payload) => phasedSyncHandlers.handlePhase2RecentChatsImpl(this, payload as Phase2RecentChatsPayload));
        webSocketService.on('phase_3_last_100_chats_ready', (payload) => phasedSyncHandlers.handlePhase3FullSyncImpl(this, payload as Phase3FullSyncPayload));
        webSocketService.on('phased_sync_complete', (payload) => phasedSyncHandlers.handlePhasedSyncCompleteImpl(this, payload as PhasedSyncCompletePayload));
        webSocketService.on('sync_status_response', (payload) => phasedSyncHandlers.handleSyncStatusResponseImpl(this, payload as SyncStatusResponsePayload)); 
