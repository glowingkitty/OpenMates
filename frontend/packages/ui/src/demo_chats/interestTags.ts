...
export const INTEREST_TAGS: InterestTag[] = [
  {
    ...
    dailyInspirations: ["sandbox-code-execution", "cli-parity", "rest-api", "webhooks"],
  ...
  },
  {
    ...
    dailyInspirations: ["cli-parity", "rest-api", "webhooks", "sandbox-code-execution"],
  ...
  },
  {
    ...
    dailyInspirations: ["provider-independent", "cli-parity", "rest-api", "webhooks"],
  ...
  },
  {
    ...
    dailyInspirations: ["trusted-quotes", "document-upload", "rest-api"],
    introChats: ["demo-for-developers"],
    exampleChats: [
      "example-svelte-runes-docs",
      "example-openmates-add-app-skill-doc",
  ...
  },
  {
    ...
    dailyInspirations: ["document-upload", "trusted-quotes", "pii-detection", "offline-search"],
  ...
  },
  {
    ...
    dailyInspirations: ["image-upload", "document-upload"],
    introChats: ["demo-for-everyone"],
  ...
  },
  {
    ...
    dailyInspirations: ["trusted-quotes", "offline-search"],
    introChats: ["demo-for-everyone"],
  ...
  },
  {
    ...
    dailyInspirations: ["audio-messages", "relevant-memories"],
    introChats: ["demo-for-everyone"],
