...
// contract-test: direct surface=gui.web assertions=projects.remote-access.task-sync,tasks.conversation.single-owner-claim,tasks.conversation.confirmed-deletion,tasks.dependencies.ready-transition
