...
/**
 * Log in to the test account with email, password, and OTP.
 * Reused login pattern from model-override.spec.ts.
 */
...
async function startNewChat(
	...
	const newChatButtonSelectors = ['.icon_create', '.new-chat-cta-button'];
	...
	logCheckpoint('Started new chat.');
}
 ...
 * Opens the sidebar, right-clicks the active chat, and confirms deletion.
 */
async function deleteActiveChat(
	...
	try {
		...
		// Two clicks: first enters confirm mode, second confirms
