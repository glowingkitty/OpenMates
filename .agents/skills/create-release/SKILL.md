...
Current phase: **Alpha**. Product UI shows short product lines such as `v0.22`; release tags and package/image artifacts use exact alpha-train versions such as `v0.22.0-alpha.0`, `v0.22.0-alpha.1`, and `v0.22.0-alpha.2`. Check the latest tag:
```bash
...
|-------------|------|---------|
| New features | Minor product line | v0.22 → v0.22 |
| Bug fixes / repeated dev publishes | Alpha artifact | v0.22.0-alpha.0 → v0.22.0-alpha.1 |
| Breaking changes | Major | v0.22 → v1.0 |
