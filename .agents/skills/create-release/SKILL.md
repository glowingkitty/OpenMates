...
Current phase: **Alpha**. Product UI shows short product lines such as `v0.19`; release tags and package/image artifacts use exact alpha-train versions such as `v0.19.0-alpha.0`, `v0.19.0-alpha.1`, and `v0.19.0-alpha.2`. Check the latest tag:
```bash
...
|-------------|------|---------|
| New features | Minor product line | v0.19 → v0.19 |
| Bug fixes / repeated dev publishes | Alpha artifact | v0.19.0-alpha.0 → v0.19.0-alpha.1 |
| Breaking changes | Major | v0.19 → v1.0 |
