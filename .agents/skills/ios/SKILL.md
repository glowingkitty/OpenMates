...
1. Read `.Codex/rules/apple-ui.md` (design tokens, forbidden controls, file mappings)
2. Read `apple/AGENTS.md` (architecture, primitives, cross-references)
3. Read `apple/AGENTS.md` (implementation notes)
...
If the Swift file has no web source header, check the mapping table in `.Codex/rules/apple-ui.md`.
