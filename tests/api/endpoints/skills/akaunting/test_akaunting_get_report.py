...
def test_akaunting_get_report_DE_jobcenter_EKS():
    ...
    try:
        ...
        report = AkauntingGetReportOutput.model_validate(json_response)
    except ValidationError as e:
        pytest.fail(f"Response does not match the AkauntingGetReportOutput model: {e}, with response: {json_response}")