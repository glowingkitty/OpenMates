...
skills_code_endpoints = {
    "plan":{
        ...
        "summary": "Skill | Plan",
        "description": "<img src='images/apps/code/plan.png' alt='Plan coding requirements based on two rounds of questions.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    },
    "write":{
        "response_model":CodeWriteOutput,
        "summary": "Skill | Write",
        "description": "<img src='images/apps/code/write.png' alt='Write code based on your requirements, for an existing project or a new one.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    }
}
...
skills_business_endpoints = {
    "create_pitch":{
        ...
        "description": "<img src='images/apps/business/create_pitch.png' alt='Asks you multiple rounds of questions, and based on the answers it creates a pitch to help you communicate your idea or project, making it compelling and exciting to potential stakeholders.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    },
    "plan_application":{
        "response_model":BusinessPlanApplicationOutput,
        "summary": "Skill | Plan application",
        "description": "<img src='images/apps/business/plan_application.png' alt='Based on website URLs, documents, and requirement details,  you will be asked multiple questions and receive detailed requirements and recommendations for writing the application.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    },
    "create_application":{
        "response_model":BusinessCreateApplicationOutput,
        "summary": "Skill | Create application",
        "description": "<img src='images/apps/business/create_application.png' alt='Write an application based on detailed requirements and recommendations. For example, a funding application.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    }
}
...
tags_metadata = [
    ...
    {
        "name": "Apps | Code",
        "description": "<img src='images/apps/code.png' alt='Write, test, improve and execute code.'>"
    },
    {
        "name": "Apps | Finance",
    ...
    {
        "name": "Apps | Business",
        "description": "<img src='images/apps/business.png' alt='Manage your businesses, get recommendations and more.'>"
    },
    {
        "name": "Apps | Home",
