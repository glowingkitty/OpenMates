...
mates_endpoints = {
    "ask_mate":{
        "response_model":Task,
        "summary": "Ask",
        "description": "<img src='docs/images/mates/ask.png' alt='Send a ask to one of your AI team mates. It will then automatically decide what skills to use to answer your question or fulfill the task.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    },
    "get_all_mates":{
        "response_model":MatesGetAllOutput,
        "summary": "Get all",
        "description": "<img src='docs/images/mates/get_all.png' alt='Get an overview list of all AI team mates currently active on the OpenMates server.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500]),
    },
    "get_mate":{
        "response_model":Mate,
        "summary": "Get mate",
        "description": "<img src='docs/images/mates/get_mate.png' alt='Get all details about a specific mate. Including system prompt, available skills and more.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    },
    "create_mate":{
        "response_model":MatesCreateOutput,
        "summary": "Create",
        "description": "<img src='docs/images/mates/create.png' alt='Create a new mate on the OpenMates server, with a custom system prompt, accessible skills and other settings.'>",
    ...
    "update_mate":{
        ...
        "summary": "Update",
        "description": "<img src='docs/images/mates/update.png' alt='Update an existing mate on the server. For example change the system prompt, the available skills and more.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 409, 422, 500])
    },
    "delete_mate":{
        "summary": "Delete",
        "description": "<img src='docs/images/mates/delete.png' alt='Delete an existing mate on the server.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    }
}
...
users_endpoints = {
    "get_all_users":{
        ...
        "summary": "Get all",
        "description": "<img src='docs/images/users/get_all.png' alt='Get an overview list of all users in a team.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    },
    "get_user":{
        "response_model":dict,
        "summary": "Get user",
        "description": "<img src='docs/images/users/get_user.png' alt='Get all details about a specific user.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    },
    "create_user":{
        "response_model":UsersCreateOutput,
        "summary": "Create",
        "description": "<img src='docs/images/users/create.png' alt='Create a new user in a team.'>",
        "responses": generate_responses([201, 400, 401, 403, 409, 422, 500]),
        "status_code": 201
    },
    "update_user":{
        "response_model":User,
        "summary": "Update",
        "description": "<img src='docs/images/users/update.png' alt='Update your user account details. Change privacy settings, email address and more.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 409, 422, 500])
    },
    "replace_profile_picture":{
        "response_model":UsersReplaceProfilePictureOutput,
        "summary": "Replace profile picture",
        "description": "<img src='docs/images/users/replace_profile_picture.png' alt='Replace the current profile picture with a new one. The old picture will be deleted.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 409, 422, 500])
    },
    "create_new_api_token":{
        "response_model":UsersCreateNewApiTokenOutput,
        "summary": "Create new API token",
        "description": "<img src='docs/images/users/create_new_api_token.png' alt='Creates a new API token for your account. Your previous token will be deleted.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    }
}
...
teams_endpoints = {
    "get_all_teams":{
        ...
        "summary": "Get all",
        "description": "<img src='docs/images/teams/get_all.png' alt='Get an overview list of all teams on your OpenMates server.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    },
    "get_team":{
        "response_model":Team,
        "summary": "Get team",
        "description": "<img src='docs/images/teams/get_team.png' alt='Get all details about a specific team. Including the skill settings, privacy and more.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    }
}
...
server_endpoints = {
    "get_status":{
        "summary": "Get status",
        "description": "<img src='docs/images/server/status.png' alt='Get a summary of your current server status.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    },
    "get_settings":{
        "summary": "Get settings",
        "description": "<img src='docs/images/server/get_settings.png' alt='Get all the current settings of your OpenMates server.'>",
        "responses": generate_responses([200, 401, 403, 404, 422, 500])
    },
    "update_settings":{
        "summary": "Update settings",
        "description": "<img src='docs/images/server/update_settings.png' alt='Update any of the setting on your OpenMates server.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 409, 422, 500])
    }
}
...
billing_endpoints = {
    "get_balance":{
        ...
        "summary": "Get balance",
        "description": "<img src='docs/images/billing/get_balance.png' alt='Get your current available balance in credits for your team or user account.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    }
}
...
tasks_endpoints = {
    "get_task":{
        "response_model":Task,
        "summary": "Get task",
        "description": "<img src='docs/images/tasks/get_task.png' alt='Get a specific task, its status and if available its result.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    },
    "cancel":{
        "response_model":TasksCancelOutput,
        "summary": "Cancel",
        "description": "<img src='docs/images/tasks/cancel.png' alt='Cancel a specific task. If its already running, it will be gracefully stopped.'>",
        "responses": generate_responses([200, 400, 401, 403, 404, 422, 500])
    }
}
...
tags_metadata = [
    ...
    {
        "name": "Workflows",
        "description": "<img src='docs/images/workflows.png' alt='A skill is powerful. Combining multiple skills in a workflow is magical.'>"
    },
    {
        "name": "Tasks",
        "description": "<img src='docs/images/tasks.png' alt='A task is a scheduled run of a single skill or a whole workflow. It can happen once, or repeated.'>"
    },
    {
        "name": "Billing",
        "description": "<img src='docs/images/billing.png' alt='Manage your billing settings, download invoices and more.'>"
    },
    {
        "name": "Server",
        "description": "<img src='docs/images/server.png' alt='Manage your OpenMates server. Change settings, see how the server is doing and more.'>"
    },
    {
        "name": "Teams",
        "description": "<img src='docs/images/teams.png' alt='Manage the teams on your OpenMates server.'>"
    },
    {
        "name": "Users",
        "description": "<img src='docs/images/users.png' alt='Manage user accounts of a team. A user can get personalized responses from mates and access to the OpenMates API.'>"
    }
]
