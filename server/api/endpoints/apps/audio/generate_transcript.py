...
from server.api.endpoints.apps.audio.providers.openai.generate_transcript import generate_transcript as generate_transcript_openai
from server.api.endpoints.apps.audio.providers.assemblyai.generate_transcript import generate_transcript as generate_transcript_assemblyai
