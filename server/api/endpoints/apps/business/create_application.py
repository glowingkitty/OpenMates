from server.api.models.apps.business.skills_business_create_application import BusinessCreateApplicationOutput, BusinessCreateApplicationInput
...
from server.api.models.apps.business.skills_business_create_application import ApplicationFormQuestion
