...
from server.api.models.apps.apps_get_one import App
...
class SkillMini(BaseModel):
    ...
    app_slug: str = Field(..., description="Slug of the app related to the skill")
    api_endpoint: str = Field(..., description="API endpoint of the skill")

    @field_validator('api_endpoint')
    @classmethod
    def validate_api_endpoint(cls, v: str) -> str:
        pattern = r'^/v1/[a-z0-9-]+/apps/[a-zA-Z0-9_.-]+/[a-zA-Z0-9_.-]+$'
...
class Skill(BaseModel):
    ...
    app: App = Field(..., description="App of the skill")
...
skills_get_one_output_example = {
    "id": 1,
    "api_endpoint": "/v1/ai-sales-team/apps/claude/ask",
    "name": "Ask",
