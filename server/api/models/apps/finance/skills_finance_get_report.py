...
# POST /{team_slug}/apps/finance/get_report (get a report)

class FinanceGetReportInput(BaseModel):
    """This is the model for the incoming parameters for POST /{team_slug}/apps/finance/get_report"""
...
class FinanceGetReportOutput(FinanceGetReportInput):
    """This is the model for the output of POST /{team_slug}/apps/finance/get_report"""
