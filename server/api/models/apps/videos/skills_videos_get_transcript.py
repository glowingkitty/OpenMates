...
# POST /{team_slug}/apps/video/transcript (get transcript of a video)

class VideosGetTranscriptInput(BaseModel):
    """This is the model for the incoming parameters for POST /{team_slug}/apps/video/transcript"""
...
class VideosGetTranscriptOutput(BaseModel):
    """This is the model for the output of POST /{team_slug}/apps/videos/transcript"""
