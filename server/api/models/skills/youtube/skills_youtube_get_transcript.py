...
class YouTubeGetTranscriptInput(BaseModel):
    """This is the model for the incoming parameters for POST /{team_slug}/skills/youtube/transcript"""
...
class YouTubeGetTranscriptOutput(BaseModel):
    """This is the model for the output of POST /{team_slug}/skills/youtube/transcript"""
    transcript: dict = Field(..., description="Transcript of the YouTube video with timestamps as keys and text as values.")
