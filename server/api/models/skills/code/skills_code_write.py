...
from server.api.models.skills.code.skills_code_plan import FileContext

# POST /{team_slug}/skills/code/write (generate or update code based on plan)

class CodeWriteInput(BaseModel):
    """This is the model for the incoming parameters for POST /{team_slug}/skills/code/write"""
...
class CodeWriteOutput(BaseModel):
    """This is the model for the output of POST /{team_slug}/skills/code/write"""
