    ...
    try:
        ...
        for skill in skills:
            ...
            if status_code == 200 and len(skill_json_response["data"])>0:
                ...
                skill_data["software"]["api_endpoint"] = f"/{team_url}/skills/{skill_json_response['data'][0]['attributes']['software']['data']['attributes']['slug']}/{skill_json_response['data'][0]['attributes']['slug']}"
