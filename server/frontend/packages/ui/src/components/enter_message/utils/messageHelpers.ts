...
import { convertToMarkdown } from './editorHelpers';
 ...
 */
export function createMessagePayload(editor: Editor) {
 ...
 */
export function resetEditorContent(editor: Editor, defaultMention: string = 'sophia') {
