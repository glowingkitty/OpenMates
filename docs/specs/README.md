...
`contract_refs`, contract/assertion impact, and documentation impact. Complete,
deployed or released V3 specs become archive-eligible after a 30-day cooling
period. `python3 scripts/contracts.py archive-specs` moves them into a year-based
