...
For overall encryption architecture, see [Zero-Knowledge Storage](../core/zero-knowledge-storage.md).
For authentication implementation, see [Signup & Login](../core/signup-and-auth.md).
