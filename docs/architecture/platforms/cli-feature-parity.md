...
claims:
- id: arch-platforms-cli-feature-parity-behavior
  type: unit
  claim: CLI Feature Parity is grounded in current source-of-truth files that parse or resolve successfully.
  source:
  - frontend/packages/openmates-cli/src/cli.ts
  - frontend/packages/openmates-cli/src/client.ts
  - frontend/packages/openmates-cli/src/mentions.ts
  ...
  test:
    ...
    assertion: arch-platforms-cli-feature-parity-behavior
  verified: '2026-06-11'
- id: arch-platforms-cli-feature-parity-source-1
  type: static
  file: scripts/tests/test_architecture_static_claims.py
  assertion: arch-platforms-cli-feature-parity-source-1
  anchors:
  - type: file_exists
    path: backend/core/api/app/routes/settings.py
- id: arch-platforms-cli-feature-parity-source-2
  type: static
  file: scripts/tests/test_architecture_static_claims.py
  assertion: arch-platforms-cli-feature-parity-source-2
  anchors:
  - type: file_exists
    path: frontend/packages/openmates-cli/src/cli.ts
- id: arch-platforms-cli-feature-parity-source-3
  type: static
  file: scripts/tests/test_architecture_static_claims.py
  assertion: arch-platforms-cli-feature-parity-source-3
  anchors:
  - type: file_exists
...
- CLI help and `docs/user-guide/cli/settings.md` list account deletion and recovery/security operations as web-only.
...
- `frontend/packages/openmates-cli/src/client.ts`
- `frontend/packages/openmates-cli/src/cli.ts`
- `docs/user-guide/cli/settings.md`
...
- [CLI Settings](../../user-guide/cli/settings.md) -- user-facing settings command reference.
