...
- [REST API Architecture](../apps/rest-api.md) - REST API endpoints and authentication
- [Security Architecture](../core/security.md) - Overall security model and encryption
