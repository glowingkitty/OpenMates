...
**Important:** The REST API is separate from the CLI package (pip/npm). The REST API cannot decrypt/encrypt chats, so for chat management you need to use the pip or npm packages. See [CLI Package Architecture](../planned/cli-package.md) for details.
...
**API Key Security**: API keys can be scoped to specific apps/skills for fine-grained permissions. See [Developer Settings](../infrastructure/developer-settings.md) for API key management.
...
For details on action confirmation architecture, see [Action Confirmation Architecture](./action-confirmation.md).
...
For more details on the multiple requests pattern, see [App Skills Architecture](../../user-guide/apps/skills.md#multiple-requests-per-skill-call).
...
For user-facing documentation on focus modes, see [Focus Modes](../../user-guide/apps/focus-modes.md).
...
- [App Skills Architecture](../../user-guide/apps/skills.md) - Detailed skill implementation patterns
- [Focus Modes](../../user-guide/apps/focus-modes.md) - User-facing focus mode documentation
- [Function Calling](./function-calling.md) - How LLM function calling integrates with apps
- [CLI Package Architecture](../planned/cli-package.md) - CLI and SDK access (includes chat encryption/decryption)
- [Servers Architecture](../core/servers.md) - Docker container architecture for apps
