...
Function calling is integrated into the main processing stage. See [Message Processing Architecture](../messaging/message-processing.md#main-processing) for the complete flow.
...
For implementation details, see [Message Processing Architecture](../messaging/message-processing.md#tool-preselection).
...
Skills can handle multiple requests in a single call (up to 5 parallel requests). Requests are processed in parallel using `asyncio.gather()` within the skill's `execute()` method. Each request must include a unique `id` field, and results are grouped by `id` in the response. See [App Skills Architecture](../../user-guide/apps/skills.md#multiple-requests-per-skill-call) for details.
...
- [Message Processing Architecture](../messaging/message-processing.md) - Complete message processing pipeline
- [App Skills Architecture](../../user-guide/apps/skills.md) - Detailed skill implementation
- [Focus Modes](../../user-guide/apps/focus-modes.md) - User-facing focus mode documentation
- [REST API Architecture](./rest-api.md) - Programmatic API access
- [Apps Architecture](../../user-guide/apps/README.md) - Overview of apps, skills, and focus modes
