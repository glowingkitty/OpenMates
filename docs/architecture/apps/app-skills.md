...
**Embeds Architecture**: Skill results are stored as separate embed entities and referenced in messages. See [Embeds Architecture](../messaging/embeds.md) for details on how skill results are stored, updated, and referenced.
