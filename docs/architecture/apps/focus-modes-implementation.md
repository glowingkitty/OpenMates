...
- [App Settings & Memories](../../user-guide/apps/settings-and-memories.md) - Similar system message pattern
- [Message Processing](../messaging/message-processing.md) - Overall processing pipeline
