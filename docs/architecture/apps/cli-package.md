...
> npm package (`openmates`, v0.8.0-alpha.1) providing both a CLI and a programmatic SDK for pair-auth login, encrypted chat operations, app skill execution, settings management, and self-hosted server management.
