...
> npm package (`openmates`, v0.11.0-alpha.0) providing both a CLI and a programmatic SDK for pair-auth login, encrypted chat operations, app skill execution, settings management, and self-hosted server management.
