...
- Client ContentStore:
    - Provides `put/get/ensure/subscribe` to manage content in memory and IndexedDB (stored encrypted using master encryption key, see [security.md](../core/security.md))
