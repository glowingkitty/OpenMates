...
**API Key Security**: API keys can be scoped to specific apps/skills for fine-grained permissions. See [Developer Settings](./developer-settings.md) for API key management.
...
For details on action confirmation architecture, see [Action Confirmation Architecture](../apps/action-confirmation.md).
...
For more details on the multiple requests pattern, see [App Skills Architecture](../apps/skills.md#multiple-requests-per-skill-call).
...
For user-facing documentation on focus modes, see [Focus Modes](../apps/focus-modes.md).
...
- [App Skills Architecture](../apps/skills.md) - Detailed skill implementation patterns
- [Focus Modes](../apps/focus-modes.md) - User-facing focus mode documentation
- [Function Calling](../apps/function-calling.md) - How LLM function calling integrates with apps
