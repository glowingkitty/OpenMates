...
4. Always required: every sensitive app skill use and including app memories content requires confirmation in chat in web app
...
- once manually or auto confirmed: process email and fullfill request (but send notification via web app and email response if an app skill use or including app memories requires web app confirmation)
