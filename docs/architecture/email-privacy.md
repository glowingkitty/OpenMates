...
For overall encryption architecture, see [Zero-Knowledge Storage](./zero-knowledge-storage.md).
For authentication implementation, see [Signup & Login](./signup-and-auth.md).
