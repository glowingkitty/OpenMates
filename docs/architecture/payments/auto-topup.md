...
key_files:
  ...
  - frontend/packages/ui/src/components/signup/steps/autotopup/*.svelte
---

# Auto Top-Up Architecture

> Monthly auto top-up is fully implemented via Stripe subscriptions. Low-balance auto top-up is planned but not yet implemented.
