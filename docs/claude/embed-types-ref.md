...
Load on demand: `python3 scripts/sessions.py context --doc embed-types-ref`
...
**All 20 locales are required.** Do not skip any. See `docs/claude/i18n.md` and `docs/claude/manage-translations.md`.
