...
1. Validate all planned interactions in Firecrawl browser first (mandatory)
2. Write the test plan in natural language, get user approval
3. Read `chat-flow.spec.ts` as the baseline template
4. Investigate DOM interactions for complex components
