...
Detailed rebuild commands, REST API documentation guide, and code patterns.
Load on demand: `python3 scripts/sessions.py context --doc backend-standards-ref`

For rules, see `backend-standards.md` (loaded automatically by tag).

---

# Backend Standards (Full Guide)
