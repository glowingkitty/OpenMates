...
- [Function Calling](../../architecture/apps/function-calling.md) - How LLM function calling integrates with apps
- [Focus Modes Implementation](../../architecture/apps/focus-modes-implementation.md) - Technical implementation details
- [Action Confirmation](../../architecture/apps/action-confirmation.md) - Security for write/sensitive operations
- [App Skills Architecture](../../architecture/apps/app-skills.md) - Technical architecture details
- [REST API](../../architecture/apps/rest-api.md) - Developer API for skills and focus modes
