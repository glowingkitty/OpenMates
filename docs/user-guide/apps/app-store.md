...
Each app is shown as a card with its icon, name, and a short description. Click on any card to see full details.

### App Details

When you open an app, you can see:
...
Apps are organised into helpful categories:

- **Top picks for you** -- Personalised recommendations based on your conversations
- **Most used** -- The most popular apps across all users in the last 30 days
- **New apps** -- Recently added apps
- **For work** -- Productivity and professional tools
- **For everyday life** -- General purpose apps for daily use

You can also search for apps by name, description, or skill name.

## Managing Apps

- All apps are available by default
- You can remove apps you do not need by clicking "Uninstall" in the app details
- Removed apps will not be used by your mates when processing your messages
- You can reinstall any removed app at any time
