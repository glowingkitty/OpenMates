...
2. **Through the Apps** -- Go to Settings > Apps > select an app to view and manage its settings and memories directly. You can add, edit, or delete entries at any time.

### Permission System

Your data is private. When your mate needs access to your saved data during a conversation:
...
This happens once per conversation and per type of data. Your mate cannot access your saved data without asking.
