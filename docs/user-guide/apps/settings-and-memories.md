...
For encryption architecture, see [security.md#app-settings--memories](../../architecture/core/security.md#app-settings--memories).
...
For detailed information on action confirmation architecture, see [Action Confirmation Architecture](../../architecture/apps/action-confirmation.md).
...
4. **User clicks "Confirm"** on preview → client generates entry_id and metadata, encrypts entry using app-specific encryption key (see [security.md#app-settings--memories](../../architecture/core/security.md#app-settings--memories))
