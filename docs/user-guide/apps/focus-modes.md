...
Developers can activate focus modes programmatically via the REST API. See [REST API documentation](../../architecture/apps/rest-api.md) for technical details.
...
If you're building integrations with OpenMates, see the [REST API documentation](../../architecture/apps/rest-api.md) for technical details on activating focus modes programmatically.

## Related Documentation

- [Apps Architecture](./README.md) - Overview of apps, skills, and focus modes
- [App Store](./app-store.md) - Browse and discover apps and their focus modes
- [Function Calling](../../architecture/apps/function-calling.md) - How focus modes integrate with the AI system
- [REST API](../../architecture/apps/rest-api.md) - Developer API for focus mode activation
