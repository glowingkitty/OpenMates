...
| `om.plans.createAssumption()` | `om.plans.create_assumption()` | `id, input` | `id, input` | `object` |
...
| `om.plans.createReferencePattern()` | `om.plans.create_reference_pattern()` | `id, input` | `id, input` | `object` |
