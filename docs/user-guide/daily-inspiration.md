...
Daily inspiration generation is **free** -- you are not charged for the inspirations themselves. Credits are only used when you reply in the chat that opens from an inspiration.
