...
Check out the [docs](/docs/getting-started/README.md) and [issues](https://github.com/glowingkitty/OpenMates/issues) in the GitHub repo to get an overview of the project and the current state of the development and feel free to create issues, ask questions and contribute to the project.
