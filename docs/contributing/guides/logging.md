...
- `docs/architecture/data/sync.md` → Sync and encryption flows
- `docs/architecture/messaging/message-processing.md` → AI message handling
- `docs/architecture/payments/payment-processing.md` → Billing flows
...
- Sync architecture: `docs/architecture/data/sync.md`
