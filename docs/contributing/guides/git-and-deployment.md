...
**Current phase:** Alpha — the app is currently at **v0.9 alpha** (user-facing version string). The next release tag should be `v0.10.0-alpha` (or a patch like `v0.9.1-alpha` for fix-only releases).
