...
- `dev` publishes the next alpha on the configured fixed train. For example, `0.21.0a0`, then `0.21.0a1`.
- `main` publishes the configured stable base, for example `0.21.0`, and PyPI skips duplicate files if that exact version already exists.
