...
```json
{
  "results": [
    ...
    {
      "id": "abc-123",
      "results": [{ "title": "Android 14", "url": "...", "description": "..." }]
    },
    {
      "id": 2,
      "results": [
...
For detailed implementation guidelines, detection patterns, testing guidelines, and alternative prompt formats, see [Prompt Injection Protection](../architecture/prompt-injection.md).
