...
- See [Developer Settings](../architecture/developer-settings.md) for details
...
- [App Settings and Memories](./settings-and-memories.md) - Connected accounts and token storage
- [REST API Architecture](../architecture/rest-api.md) - API endpoints and authentication
- [Developer Settings](../architecture/developer-settings.md) - API key management and device confirmation
- [App Skills Architecture](./skills.md) - How app skills work
