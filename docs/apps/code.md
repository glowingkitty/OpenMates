...
3. Process each chunk through the prompt injection detection system (see [Prompt Injection Protection](../architecture/prompt-injection.md))
...
- See [LLM Hallucination Mitigation](../architecture/hallucination-mitigation.md) for details on how this fits into the broader strategy to reduce hallucinations and ensure accuracy.
