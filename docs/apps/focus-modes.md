...
Developers can activate focus modes programmatically via the REST API. See [REST API documentation](../architecture/rest-api.md) for technical details.
...
If you're building integrations with OpenMates, see the [REST API documentation](../architecture/rest-api.md) for technical details on activating focus modes programmatically.
...
- [Function Calling](./function-calling.md) - How focus modes integrate with the AI system
- [REST API](../architecture/rest-api.md) - Developer API for focus mode activation
