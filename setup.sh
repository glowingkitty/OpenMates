...
setup_env_file() {
    ...
    update_if_empty "CELERY_AUTOSCALE_MAX" "3"
    update_if_empty "CELERY_AUTOSCALE_MIN" "1"
    update_if_empty "TASK_WORKER_CONCURRENCY" "3"
    update_if_empty "APP_AI_WORKER_CONCURRENCY" "3"
    update_if_empty "APP_IMAGES_WORKER_CONCURRENCY" "3"
    update_if_empty "APP_MUSIC_WORKER_CONCURRENCY" "2"
    update_if_empty "TASK_WORKER_MEMORY_LIMIT" "3g"
    update_if_empty "APP_AI_WORKER_MEMORY_LIMIT" "2g"
    update_if_empty "APP_IMAGES_WORKER_MEMORY_LIMIT" "1792m"
    update_if_empty "APP_MUSIC_WORKER_MEMORY_LIMIT" "1536m"
    update_if_empty "APP_VIDEOS_WORKER_MEMORY_LIMIT" "1280m"
    update_if_empty "APP_PDF_WORKER_MEMORY_LIMIT" "1536m"
    update_if_empty "APP_DOCS_WORKER_MEMORY_LIMIT" "1536m"
    update_if_empty "APP_CODE_WORKER_MEMORY_LIMIT" "1g"
    update_if_empty "APP_SOCIAL_MEDIA_WORKER_MEMORY_LIMIT" "1536m"
